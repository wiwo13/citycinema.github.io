  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <?php
            $th=mysqli_query($con,"select * from tbl_theatre where id='1'");
            $theatre=mysqli_fetch_array($th);
          ?>
            <table class="table table-bordered table-hover">
                <tr>
                    <td class="col-md-6" style="color:red">Theater Name</td>
                    <td  class="col-md-6" style="color:red"><?php echo $theatre['name'];?></td>
                </tr>
                <tr>
        ...
        <div class="box-body">
          <?php
            $th=mysqli_query($con,"select * from tbl_theatre where id='2'");
            $theatre=mysqli_fetch_array($th);
          ?>
            <table class="table table-bordered table-hover">
                <tr>
        ...
        <div class="box-body">
          <?php
            $th=mysqli_query($con,"select * from tbl_theatre where id='3'");
            $theatre=mysqli_fetch_array($th);
          ?>
            <table class="table table-bordered table-hover">
                <tr>
