    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-body">
           ...
           $qry12=mysqli_query($con,"select show_date from tbl_show_time where st_id='".$mn['st_id']."'");
					 $scrr=mysqli_fetch_array($qry12);
                ...
                <tr>
                  ...
                  <td><span class="badge bg-light-blue"><?php echo $scrr['show_date'];?><?php echo "/"?><?php echo $scr['start_time'];?>(<?php echo $scr['name'];?>)</span></td>
