						...
						<h3 style="color:#444; font-size:23px;" class="text-center"><?php echo $movie['movie_name']; ?></h3>	
							...
							<?php
								...
								while($shw=mysqli_fetch_array($s))
								{
									...
									$t1=mysqli_query($con,"select * from tbl_theatre where id='1'");
									$theatre1=mysqli_fetch_array($t1);
									$t2=mysqli_query($con,"select * from tbl_theatre where id='2'");
									$theatre2=mysqli_fetch_array($t2);
									$t3=mysqli_query($con,"select * from tbl_theatre where id='3'");
									$theatre3=mysqli_fetch_array($t3);
									?>
									...
									<tr>
										<td >
											<?php echo $theatre1['name'].", ".$theatre1['place'];?>
										</td>
									...
									<tr>
										<td >
											<?php echo $theatre2['name'].", ".$theatre2['place'];?>
										</td>
									...
									<tr>
										<td >
											<?php echo $theatre3['name'].", ".$theatre3['place'];?>
										</td>
