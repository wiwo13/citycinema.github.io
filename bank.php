<!-- I copied index.php into bank.php -->
...
include_once('connection.php');
 if(isset($_REQUEST['login']))
 {
   ...
   $select_query = mysqli_query($connection,"select * from tbl_registration where email='$email'");
   ...
   if($res>0)
   {
     ...
     $name = $data['name'];
     $_SESSION['name'] = $name;
     $otp = rand(10000, 999999);   //Generate OTP
 ...
 $mail->Port = 587; 
 $mail->Username = "cmk1622004@gmail.com"; // Enter your username
 $mail->Password = "fcjn nrjs wubx vxzu"; // Enter Password
 $mail->FromName = "CityCinema ";
...
<body>  
    ...
    <h3 align="center">Email Vertifiction OTP</h3><br/>
    <div class="box">
     <form method="post" >  
